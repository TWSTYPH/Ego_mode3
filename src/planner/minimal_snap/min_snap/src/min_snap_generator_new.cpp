...
void eight_goal_cb(const geometry_msgs::PoseStamped target_info)
{
    ...
    //                                   {0.6 , 0.9},\
    //                                   {0.0 , 0.0 } };                                  
    // std::vector<Eigen::Vector3d> list{{0.0 , 0.0 , 0.8},\
    //                                   {0.6 , -0.9 , 0.8},\
    //                                   {1.5 , -1.5 , 0.3},\
    //                                   {2.2 , -1.2 , 0.5},\
    //                                   {2.4 , -0.5 , 0.8},\
    ...
    for (size_t i=0; i<list.size(); i++)
    {
        ...
        tmp_pt.position.z += GOAL_HEIGHT + 0.1 * i;
...
//         for (int i = 0; i < goal_list.poses.size(); i++)
//         {
//             // std::cout<<"AAAAAAAAAA"<<goal_list.poses[i]<<std::endl;
//             goal_list.poses[i].position.z = i*0.5 + GOAL_HEIGHT;
//         }
...
//         tmp_pt.position.x += list[i][0]*scale; 
//         tmp_pt.position.y += list[i][1]*scale;
//         tmp_pt.position.z = GOAL_HEIGHT + 0.05*i;
//         goal_list.poses.push_back(tmp_pt);
//     }
